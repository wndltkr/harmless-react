...
const Apply1Page = () => {
    ...
    return (
        <div className="apply1-container">
            <div className="apply1-header">
                <h2>대면 수거 신청</h2>
                <p className="sub-text">* 표시는 필수 입력 항목입니다.</p>
            </div>

            <form onSubmit={handleSubmit} className="apply1-form">
